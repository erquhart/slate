...
For most folks, you'll want to install Slate via `npm`, in which case you can follow the regular [Installing Slate](https://github.com/erquhart/slate/tree/1141f59f4f9b1f9158e9b96e19bf11ef9fb3dbce/docs/walkthroughs/installing-slate.md) guide.
